document.addEventListener('DOMContentLoaded', function() {
    ...
    function abrirPanel(mascotaData, clickedCard) {
        ...
        panelContacto.href = mascotaData.contactoUrl;

        // Mostrar el panel
        panelDetalles.classList.add('active');
        // Opcional: scroll a la parte superior del panel al abrirlo
        ...
        tarjeta.addEventListener('click', function() {
            ...
            if (this === currentSelectedCard && panelDetalles.classList.contains('active')) {
                ...
                const mascota = {
                    ...
                    contactoUrl: tarjeta.dataset.contactoUrl,
    ...
    document.addEventListener('click', function(event) {
        const isClickInsidePanel = panelDetalles.contains(event.target) || event.target.closest('.tarjeta-mascota');
        const isPanelActive = panelDetalles.classList.contains('active');

        if (isPanelActive && !isClickInsidePanel) {
            cerrarPanel();
        }
    });
});